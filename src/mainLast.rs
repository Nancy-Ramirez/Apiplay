...
async fn main() -> std::io::Result<()> { //Función principal
    ...
    .bind(("127.0.0.1", 8080))? //bind es un metodo que especifica la dirección IP y el purto, la interrogancion maneja cualquier error que pueda ocurrir durante el proceso. Enlaza el servidor de actix a una dirección IP y puertos especificos.
